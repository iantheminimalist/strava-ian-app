...
function App() {
  ...
  return (
    <div className='absolute min-h-screen bg-gradient-to-br from-orange-800 from-10% v	to-sky-950  to-90% min-h-screen w-full'>
      ...
      <nav className=' shadow-md bg-white flex justify-between items-center p-3 border-b-2 border-gray-300 z-1'>
        ...
        <div className='  '>
          <NavLink to="/" className='w-100 cursor-pointer flex items-center'>
        ...
        <div className=''>
          <ul className={`  md:flex md:justify-center md:items-center md:static md:auto md:z-auto 
            ...
            <li className='md:mr-5 my-3 md:mb-0 p-3 '>
              <NavLink className={ ({ isActive }) => isActive ? "text-orange-700 font-semibold" : "text-sky-950" + " hover:text-orange-700  font-semibold hover:duration-500"  } to="/">Home</NavLink>
                  </li> 
            <li className='md:mr-5 my-3 md:mb-0 p-3' >
              <NavLink className={ ({ isActive }) => isActive ? "text-orange-700 font-semibold" : "text-sky-950" + " hover:text-orange-700  font-semibold hover:duration-500"  } to="pages/about">About</NavLink>
            </li>
            <li className='md:mr-5 my-3 md:mb-0 p-3' >
              <NavLink className={ ({ isActive }) => isActive ? "text-orange-700 font-semibold" : "text-sky-950" + " hover:text-orange-700  font-semibold hover:duration-500"  } to="pages/activity">Activity</NavLink>
            </li>
            <li className='md:mr-5 my-3 md:mb-0 p-3' >
              <NavLink className={ ({ isActive }) => isActive ? "text-orange-700 font-semibold" : "text-sky-950" + " hover:text-orange-700  font-semibold hover:duration-500"  } to="pages/activities">Activities</NavLink>
            </li>
          </ul>
        </div>
